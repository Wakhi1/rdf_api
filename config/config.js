...
const config = {
  ...
  jwt: {
    ...
    accessExpiresIn: process.env.JWT_ACCESS_EXPIRY || '45m',
  ...
  frontend: {
    url: process.env.FRONTEND_URL || 'http://localhost:63520' // Add this section
  },
  cors: {
    origin: process.env.CORS_ORIGIN || 'http://localhost:63520',
    credentials: true
  },
  roles: [
    'EOG', 
